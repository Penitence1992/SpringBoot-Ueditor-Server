...
public final class ConfigManager {
    ...
    private ConfigManager (String rootPath,String originalPath) throws IOException {
        rootPath = rootPath.replace( "\\", "/" );
    ...
    public static ConfigManager getInstance(String rootPath, String originalPath){
        try {
            return new ConfigManager(rootPath, originalPath);
        } catch ( Exception e ) {
            return null;
        }
    }
